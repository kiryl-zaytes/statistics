...
ggplot(aes(gained), data=nc) + geom_histogram(binwidth = 4)
```
...
ggplot(aes(x=1, y=weight), data = nc) + geom_boxplot(aes(color=habit))
...
inference(y = weeks, data = nc, statistic = "mean", type = "ci", 
          method = "theoretical", order = c("smoker","nonsmoker"), conf_level = 0.90)
```
